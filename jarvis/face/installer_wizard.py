    ...
    class APIKeyPage(QWizardPage):
        ...
        def _validate_gemini(self):
            ...
            if not key:
                ...
                self.gemini_status.setStyleSheet("color: orange;")
                return
            self.gemini_status.setText("Validating...")
            self.gemini_status.setStyleSheet("color: gray;")
            QApplication.processEvents()

            if validate_gemini_key(key):
                self.gemini_status.setText("Valid!")
                self.gemini_status.setStyleSheet("color: green; font-weight: bold;")
            else:
                self.gemini_status.setText("Invalid key")
                self.gemini_status.setStyleSheet("color: red; font-weight: bold;")
